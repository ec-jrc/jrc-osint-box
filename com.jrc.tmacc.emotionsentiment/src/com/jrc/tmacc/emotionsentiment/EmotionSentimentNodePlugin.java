 ...
 */
public class EmotionSentimentNodePlugin extends Plugin {
    // The shared instance.
    private static EmotionSentimentNodePlugin plugin;

    /**
     * The constructor.
     */
    public EmotionSentimentNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static EmotionSentimentNodePlugin getDefault() {
        return plugin;
    }
