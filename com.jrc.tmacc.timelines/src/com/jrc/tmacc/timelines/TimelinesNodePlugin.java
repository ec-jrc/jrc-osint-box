 ...
 */
public class TimelinesNodePlugin extends Plugin {
    // The shared instance.
    private static TimelinesNodePlugin plugin;

    /**
     * The constructor.
     */
    public TimelinesNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static TimelinesNodePlugin getDefault() {
        return plugin;
    }
