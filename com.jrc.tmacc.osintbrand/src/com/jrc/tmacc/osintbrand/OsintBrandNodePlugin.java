 ...
 * @author JRC I.3
 */
public class OsintBrandNodePlugin extends Plugin {
    // The shared instance.
    private static OsintBrandNodePlugin plugin;

    /**
     * The constructor.
     */
    public OsintBrandNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static OsintBrandNodePlugin getDefault() {
        return plugin;
    }
