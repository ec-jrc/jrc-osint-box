 ...
 * @author 
 */
public class CategoryMatcherNodePlugin extends Plugin {
    // The shared instance.
    private static CategoryMatcherNodePlugin plugin;

    /**
     * The constructor.
     */
    public CategoryMatcherNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CategoryMatcherNodePlugin getDefault() {
        return plugin;
    }
